...
#import "SGNSData+Base64.h"
#import "SGNSString+URLEncode.h"


// Signature Method strings, keep in sync with SGASIOAuthSignatureMethod
...
@implementation SGASIHTTPRequest (SGASIHTTPRequest_OAuth)
...
- (NSArray *)oauthAdditionalParametersForMethod:(SGASIOAuthSignatureMethod)signatureMethod
{
    // For sub-classes to override
    return nil;
}
